...
class ProductControllerAddNewProductTest {
    ...
    @WithMockUser(username = "testUser@email.com",
            roles = {"ADMIN", "MANAGER"})
    void testAddNewProductIfRoleAdminAndManagerAndOk() {
    ...
    @Test
    void testAddNewProductIfUserIsNotRegistered() {
        ProductRequestDto requestDto = ProductRequestDto.builder()
                .productName("TestProduct")
                .productCategory("testCategory")
                .image("https://drive.google.com/test")
    ...
    @WithMockUser(username = "testUser@email.com",
            roles = {"ADMIN", "MANAGER"})
    void testAddNewProductIfRoleAdminAndManagerAndProductNameIsTooLong() {
        ProductRequestDto requestDto = ProductRequestDto.builder()
    ...
    @WithMockUser(username = "testUser@email.com",
            roles = {"ADMIN", "MANAGER"})
    void testAddNewProductIfRoleAdminAndManagerAndProductNameIsTooShort() {
        ProductRequestDto requestDto = ProductRequestDto.builder()
                .productName("te")
                .productCategory("testCategory")
                .image("https://drive.google.com/test")
