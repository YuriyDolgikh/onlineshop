...
class StatisticControllerGetTopTenPurchasedProductsTest {
    ...
    void getTopTenPurchasedProducts() throws Exception {
        ...
        when(statisticService.getTopTenPurchasedProducts()).thenReturn(expectedTopTen);

        mockMvc.perform(get("/v1/statistics/topSold")
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.length()").value(10))
                .andExpect(jsonPath("$[0].productQuantity").value(25))
                .andExpect(jsonPath("$[9].productQuantity").value(16));
